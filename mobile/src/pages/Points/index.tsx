...
const Points = () =>{
  ...
  useEffect(() =>{
    ...
    async function loadPosition(){
      ...
      // Solicita permissao para usar geolocalizacao
  ...
  return (
    ...
    {/* Mapa */}
      <View style={styles.container}>
        ...
        <Text style={styles.description}>Encontre no mapa um ponto de colega.</Text>
